...
// TODO - some of the levels have a SPECIAL COLOR 
    ...
    export function createWalls(level:Level)
    {
      ...
      level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(16, 1.7122353047244294, 4), new Quaternion(0, 1.5265566588595902e-16, 0, 1.0000000000000004), _colorNames.WHITE)) 
      ...
      level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(9, 2.093221223224443, 4), new Quaternion(0, 1.5265566588595902e-16, 0, 1.0000000000000004), _colorNames.WHITE)) 
      level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(7, 2.1012807789052053, 4), new Quaternion(0, 1.5265566588595902e-16, 0, 1.0000000000000004), _colorNames.WHITE)) 
      ...
      level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(9, 3.5, 11.5), new Quaternion(0, 1.5265566588595902e-16, 0, 1.0000000000000004), _colorNames.WHITE)) 
      level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(23, 4, 11.5), new Quaternion(0, 1.5265566588595902e-16, 0, 1.0000000000000004), _colorNames.WHITE)) 
      level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(25, 3.5, 11.5), new Quaternion(0, 1.5265566588595902e-16, 0, 1.0000000000000004), _colorNames.WHITE)) 
      level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(27, 3, 11.5), new Quaternion(0, 1.5265566588595902e-16, 0, 1.0000000000000004), _colorNames.WHITE)) 
      level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(29, 2, 11.5), new Quaternion(0, 1.5265566588595902e-16, 0, 1.0000000000000004), _colorNames.WHITE)) 
      level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(28, 2.2920463207613544, 23.5), new Quaternion(0, 1.5265566588595902e-16, 0, 1.0000000000000004), _colorNames.WHITE)) 
      ...
      level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(22.5, 1.5, 0.5), new Quaternion(0, -1.0000000000000002, 0, 2.914335439641036e-16), _colorNames.PURPLE)) 
      level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(24.5, 1.5, 0.5), new Quaternion(0, -1.0000000000000002, 0, 2.914335439641036e-16), _colorNames.PURPLE)) 
      level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(26.5, 1.5, 0.5), new Quaternion(0, -1.0000000000000002, 0, 2.914335439641036e-16), _colorNames.PURPLE)) 
      level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(15.5, 1.5, 0.5), new Quaternion(0, -1.0000000000000002, 0, 2.914335439641036e-16), _colorNames.PURPLE)) 
      level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(13.5, 1.5, 0.5), new Quaternion(0, -1.0000000000000002, 0, 2.914335439641036e-16), _colorNames.PURPLE)) 
      level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(11.5, 1.5, 0.5), new Quaternion(0, -1.0000000000000002, 0, 2.914335439641036e-16), _colorNames.PURPLE)) 
      level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(9.5, 1.5, 0.5), new Quaternion(0, -1.0000000000000002, 0, 2.914335439641036e-16), _colorNames.PURPLE)) 
      level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(7.5, 1.5, 0.5), new Quaternion(0, -1.0000000000000002, 0, 2.914335439641036e-16), _colorNames.PURPLE)) 
      level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(3, 1.5, 0.5), new Quaternion(0, -1.0000000000000002, 0, 2.914335439641036e-16), _colorNames.PURPLE)) 
      ...
      level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(19, 3, 23.5), new Quaternion(0, 5.551115123125783e-17, 0, 0.9999999999999999), _colorNames.TURQUOISE)) 
      level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(1, 1.5, 23.5), new Quaternion(0, 5.551115123125783e-17, 0, 0.9999999999999999), _colorNames.TURQUOISE)) 
      level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(7, 1.5, 6), new Quaternion(0, 5.551115123125783e-17, 0, 0.9999999999999999), _colorNames.TURQUOISE)) 
      level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(4, 1.5, 5), new Quaternion(0, 5.551115123125783e-17, 0, 0.9999999999999999), _colorNames.TURQUOISE)) 
      level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(4, 1.5, 7), new Quaternion(0, 5.551115123125783e-17, 0, 0.9999999999999999), _colorNames.TURQUOISE)) 
      level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(3, 1.5, 8), new Quaternion(0, 5.551115123125783e-17, 0, 0.9999999999999999), _colorNames.TURQUOISE)) 
      level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(6.5, 1.5, 8), new Quaternion(0, 5.551115123125783e-17, 0, 0.9999999999999999), _colorNames.TURQUOISE)) 
      level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(6.5, 3, 12.5), new Quaternion(0, 5.551115123125783e-17, 0, 0.9999999999999999), _colorNames.TURQUOISE)) 
      level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(6.5, 3, 19), new Quaternion(0, 5.551115123125783e-17, 0, 0.9999999999999999), _colorNames.TURQUOISE)) 
      level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(11, 2.5, 28), new Quaternion(0, 5.551115123125783e-17, 0, 0.9999999999999999), _colorNames.TURQUOISE)) 
      level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(11, 4, 18), new Quaternion(0, 5.551115123125783e-17, 0, 0.9999999999999999), _colorNames.TURQUOISE)) 
