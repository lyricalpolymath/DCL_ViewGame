...
// TODO - some of the levels have a SPECIAL COLOR   YELLOW and PURPLE
    ...
    {
        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(31, 1.5, 15.5), new Quaternion(0, 0, 0, 1), _colorNames.GREEN))  // model: models/neonwall-green.glb
        ...
        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(15.5, 1.5, 31), new Quaternion(0, -0.7071067811865476, 0, 0.7071067811865476), _colorNames.RED))  // model: models/neonwall-red.glb
        ...
        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(1, 1.5, 17), new Quaternion(0, 0, 0, 1), _colorNames.TURQUOISE))  // model: models/neonwall-turquoise.glb
        ...
        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(19.5, 1.5, 1), new Quaternion(0, -0.7071067811865478, 0, 0.7071067811865478), _colorNames.WHITE))  // model: models/neonwall-white.glb
        ...
        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(18.5, 1.5, 31.5), new Quaternion(0, 0, 0, 1), _colorNames.YELLOW))  // model: models/neonwall-yellow.glb
        ...
        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(19.5, 1.5, 3), new Quaternion(0, -0.7071067811865478, 0, 0.7071067811865477), _colorNames.PURPLE))  // model: models/neonwall-purple.glb
        ...
        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(18.5, 1.5, 8), new Quaternion(0, 0, 0, 1), _colorNames.PURPLE))
        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(20.5, 1.5, 8), new Quaternion(0, 0, 0, 1), _colorNames.PURPLE))
        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(22.5, 1.5, 8), new Quaternion(0, 0, 0, 1), _colorNames.PURPLE))


        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(24, 1.5, 8.835673360750997), new Quaternion(0, -0.47139673682599775, 0, 0.8819212643483552), _colorNames.BLUE))  // model: models/neonwall-blue.glb
        ...
        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(15.5, 1.5, 9), new Quaternion(0, -0.7071067811865476, 0, 0.7071067811865476), _colorNames.BLUE))
        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(15.5, 1.5, 11), new Quaternion(0, -0.7071067811865476, 0, 0.7071067811865476), _colorNames.BLUE))
        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(16.5, 1.5, 12), new Quaternion(0, 5.551115123125783e-17, 0, 0.9999999999999999), _colorNames.BLUE))
        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(18.5, 1.5, 12), new Quaternion(0, 5.551115123125783e-17, 0, 0.9999999999999999), _colorNames.BLUE))
        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(20.5, 1.5, 12), new Quaternion(0, 5.551115123125783e-17, 0, 0.9999999999999999), _colorNames.BLUE))
        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(23.661445481822906, 1.5, 12), new Quaternion(0, 5.551115123125783e-17, 0, 0.9999999999999999), _colorNames.BLUE))
        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(25.5, 1.5, 12), new Quaternion(0, 5.551115123125783e-17, 0, 0.9999999999999999), _colorNames.BLUE))
        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(27.5, 1.5, 12), new Quaternion(0, 5.551115123125783e-17, 0, 0.9999999999999999), _colorNames.BLUE))
        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(28.5, 1.5, 11), new Quaternion(0, 0.7071067811865475, 0, 0.7071067811865475), _colorNames.BLUE))
        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(28.5, 1.5, 9), new Quaternion(0, 0.7071067811865475, 0, 0.7071067811865475), _colorNames.BLUE))
        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(28.5, 1.5, 7), new Quaternion(0, 0.7071067811865475, 0, 0.7071067811865475), _colorNames.BLUE))
        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(29.5, 1.5, 6), new Quaternion(0, 5.551115123125783e-17, 0, 0.9999999999999999), _colorNames.BLUE))
        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(30.5, 1.5, 6), new Quaternion(0, 5.551115123125783e-17, 0, 0.9999999999999999), _colorNames.BLUE))
        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(29, 1.5, 17.83408772145484), new Quaternion(0, 0.19509032201612825, 0, 0.9807852804032304), _colorNames.BLUE))
        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(27.45672122136531, 1.5, 18.8761734190171), new Quaternion(0, 0.3826834323650897, 0, 0.9238795325112867), _colorNames.BLUE))
        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(26.842164470721222, 1.5, 20.5), new Quaternion(0, 0.7071067811865474, 0, 0.7071067811865474), _colorNames.BLUE))
        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(26.842164470721222, 1.5, 20.5), new Quaternion(0, 0.7071067811865474, 0, 0.7071067811865474), _colorNames.BLUE))
        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(26.873951572967872, 1.5, 22.5), new Quaternion(0, 0.7071067811865474, 0, 0.7071067811865474), _colorNames.BLUE))
        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(27.270739370570507, 1.5, 24.356339472358012), new Quaternion(0, 0.8314696123025451, 0, 0.5555702330196023), _colorNames.BLUE))
        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(28.5, 1.5, 25.5949361155967), new Quaternion(0, 0.9807852804032304, 0, 0.19509032201612828), _colorNames.BLUE))
        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(29.78032474391376, 1.5, 25.04395592843315), new Quaternion(0, 0.8314696123025452, 0, -0.5555702330196021), _colorNames.BLUE))
        ...
        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(9.724082160043235, 1.5, 21), new Quaternion(0, -0.2902846772544624, 0, 0.9569403357322089), _colorNames.BLACK))  // model: models/neonwall-black.glb
        ...
        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(8.5, 1.5, 11), new Quaternion(0, -0.7071067811865476, 0, 0.7071067811865476), _colorNames.BLACK))
        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(11.5, 1.5, 12), new Quaternion(0, 0.5555702330196022, 0, 0.8314696123025452), _colorNames.BLACK))
        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(11.5, 1.5, 17), new Quaternion(0, 0.9238795325112865, 0, 0.3826834323650897), _colorNames.BLACK))
