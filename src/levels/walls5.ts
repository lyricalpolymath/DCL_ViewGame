...
// TODO - some of the levels have a SPECIAL COLOR   NEON_WHITE, NEON_RED, TURQUOISE, NEON_PURPLE
    ...
    export function createWalls(level:Level)
    {
        ...
        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(16, 1.5, 13.5), new Quaternion(0, 0, 0, 1), _colorNames.WHITE))  // model: models/neonwall-white.glb
        ...
        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(30, 1.5, 25), new Quaternion(0, -0.7071067811865478, 0, 0.7071067811865477), _colorNames.RED))  // model: models/neonwall-red.glb
        ...
        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(16, 1.5, 27.5), new Quaternion(0, 0, 0, 1), _colorNames.TURQUOISE))  // model: models/neonwall-turquoise.glb
        ...
        level.levelWalls.push(new Wall(level,"Wall " + level.levelWalls.length, new Vector3(1.5, 1.5, 30), new Quaternion(0, -0.7071067811865476, 0, 0.7071067811865476), _colorNames.PURPLE))  // model: models/neonwall-purple.glb
